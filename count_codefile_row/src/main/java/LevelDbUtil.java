...
public class LevelDbUtil {
    ...
    public LevelDbUtil(String dbFolder) {
        this.dbFolder = "count_codefile_row/File_Row_Count/"+dbFolder+".db";
    }
     ...
     * @param val
     */
    public void put(String key, Object val) throws UnsupportedEncodingException {
